...
public class ConcurrentDictionary2(TKey,TValue) : DotNetObject, IDictionary2!(TKey,TValue), IDictionary, IReadOnlyDictionary2!(TKey,TValue)
{
    private static class Tables : DotNetObject
    {
        public immutable Node[] m_buckets;
        public immutable DotNetObject[] m_locks;
    ...
    private static class Node : DotNetObject
    {
        public TKey m_key;
    ...
    private static class DictionaryEnumerator : DotNetObject, IDictionaryEnumerator
    {
...
//[HostProtection(Synchronization = true, ExternalThreading = true)]
//[Serializable]
public class ConcurrentQueue1(T) : DotNetObject, IProducerConsumerCollection1!(T), IReadOnlyCollection1!(T)
{
    // Ignored: //fields of ConcurrentQueue
    ...
    // Ignored: //number of snapshot takers, GetEnumerator(), ToList() and ToArray() operations take snapshot.
    // Ignored: [NonSerialized]
    ...
    private static class Segment : DotNetObject
    {
...
//[DebuggerTypeProxy(typeof(SystemCollectionsConcurrent_ProducerConsumerCollectionDebugView<>))]
//[HostProtection(Synchronization = true, ExternalThreading = true)]
public class ConcurrentStack1(T) : DotNetObject, IProducerConsumerCollection1!(T), IReadOnlyCollection1!(T)
{
    private static class Node : DotNetObject
    {
...
public final class SystemCollectionsConcurrent_ProducerConsumerCollectionDebugView1(T) : DotNetObject
{
...
public abstract class OrderablePartitioner1(TSource) : Partitioner1!(TSource)
{
    ...
    private static class EnumerableDropIndices : DotNetObject, IEnumerable1!(TSource), IDisposable
    {
    ...
    private static class EnumeratorDropIndices : DotNetObject, IEnumerator1!(TSource)
    {
...
//    /// </remarks>
//    [HostProtection(Synchronization = true, ExternalThreading = true)]
public abstract class Partitioner1(TSource) : DotNetObject
{
    //TODO: generate method GetPartitions
...
//
// Ignored: /// <summary>
// Ignored: /// Out-of-the-box partitioners are created with a set of default behaviors.
// Ignored: /// For example, by default, some form of buffering and chunking will be employed to achieve
// Ignored: /// optimal performance in the common scenario where an IEnumerable<> implementation is fast and
// Ignored: /// non-blocking.  These behaviors can be overridden via this enumeration.
// Ignored: /// </summary>
// Ignored: [Flags]
...
//    /// </remarks>
//    [HostProtection(Synchronization = true, ExternalThreading = true)]
public class Partitioner : DotNetObject
{
    ...
    //TODO: generate method Create
    //TODO: generate method CreateRanges
    private static abstract class DynamicPartitionEnumerator_Abstract2(TSource,TSourceReader) : DotNetObject, IEnumerator1!(KeyValuePair2!(long,TSource))
    {
    ...
    private static class DynamicPartitionerForIEnumerable1(TSource) : OrderablePartitioner1!(TSource)
    {
        ...
        //TODO: generate method GetOrderableDynamicPartitions
        //TODO: generate property 'SupportsDynamicPartitions'
        private static class InternalPartitionEnumerable : DotNetObject, IEnumerable1!(KeyValuePair2!(long,TSource)), IDisposable
        {
            ...
            private DotNetObject m_sharedLock;
        ...
        private static class InternalPartitionEnumerator : DynamicPartitionEnumerator_Abstract2!(TSource,IEnumerator1!(TSource))
        {
            ...
            private immutable DotNetObject m_sharedLock;
    ...
    private static class DynamicPartitionerForIList1(TSource) : DynamicPartitionerForIndexRange_Abstract2!(TSource,IList1!(TSource))
    {
        //TODO: generate constructor
        //TODO: generate method GetOrderableDynamicPartitions_Factory
        private static class InternalPartitionEnumerable : DotNetObject, IEnumerable1!(KeyValuePair2!(long,TSource))
        {
    ...
    private static abstract class StaticIndexRangePartition1(TSource) : DotNetObject, IEnumerator1!(KeyValuePair2!(long,TSource))
    {
    ...
    private static class SharedInt : DotNetObject
    {
        public /*todo: volatile*/int Value;
        //TODO: generate constructor
    }
    private static class SharedBool : DotNetObject
    {
        public /*todo: volatile*/bool Value;
        //TODO: generate constructor
    }
    private static class SharedLong : DotNetObject
    {
        public long Value;
        //TODO: generate constructor
    }
